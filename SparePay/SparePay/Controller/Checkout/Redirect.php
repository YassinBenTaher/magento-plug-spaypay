...
namespace SparePay\SparePay\Controller\Checkout;

/**
 * Return Action Controller (used to handle Redirects from the Payment Gateway)
 *
 * Class Redirect
 * @package SparePay\SparePay\Controller\Checkout
 */
class Redirect extends \SparePay\SparePay\Controller\AbstractCheckoutRedirectAction
{
    /**
