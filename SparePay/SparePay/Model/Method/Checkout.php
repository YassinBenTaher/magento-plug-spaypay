...
namespace SparePay\SparePay\Model\Method;

/**
 * Checkout Payment Method Model Class
 * Class Checkout
 * @package SparePay\SparePay\Model\Method
 */
class Checkout extends \Magento\Payment\Model\Method\AbstractMethod
{
    use \SparePay\SparePay\Model\Traits\OnlinePaymentMethod;
    use \SparePay\SparePay\Model\Traits\Logger;
     ...
     * @param \SparePay\SparePay\Helper\Data $moduleHelper
    ...
    public function __construct(
        ...
        \SparePay\SparePay\Helper\Data $moduleHelper,
    ...
    {
      $transaction = new \SparePay\GetPaymentToken;
