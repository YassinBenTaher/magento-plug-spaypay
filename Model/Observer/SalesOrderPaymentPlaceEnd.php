...
namespace SparePay\SparePay\Model\Observer;
 ...
 * @package SparePay\SparePay\Model\Observer
 */
class SalesOrderPaymentPlaceEnd implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        switch ($payment->getMethod()) {
            case \SparePay\SparePay\Model\Method\Checkout::CODE:
                $this->updateOrderStatusToNew($payment);
                break;
            case \SparePay\SparePay\Model\Method\Direct::CODE:
