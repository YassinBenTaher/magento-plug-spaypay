...
class Config implements \Magento\Payment\Model\Method\ConfigInterface
{
    ...
    {
        \SparePay\Settings::$shopId  = $this->getShopId();
        \SparePay\Settings::$shopKey = $this->getShopKey();
        \SparePay\Settings::$gatewayBase = 'https://' . $this->getDomainGateway();
        \SparePay\Settings::$checkoutBase = 'https://' . $this->getDomainCheckout();
    }
